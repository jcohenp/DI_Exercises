...
function createListItem(itemValue) {
    ...
    console.log(itemValue; newItem.innerHTML = itemValue; newItem.style.color = "white"
        console.log("ItemCreate " + itemValue); console.log("createListItem " + newItem); styleAll(newItem); parent.appendChild(newItem);
    }
