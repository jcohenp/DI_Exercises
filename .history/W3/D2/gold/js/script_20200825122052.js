...
function createForm() {
    ...
    button.addEventListener('keypress', function(e) {
            if (e.key === 'Enter') {
                (console.log("C") addItem(itemValue);
                }
        ...
        let buttonClear = document.createElement("button"); buttonClear.innerHTML = "CLEAR ALL"; inputForm.appendChild(buttonClear); styleAll(buttonClear); buttonClear.style.backgroundColor = "yellow"; buttonClear.style.color = "black";
    }
